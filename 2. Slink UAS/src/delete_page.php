...
<body>
    <main class="animasi">
        <div class="login border shadow p-3 mb-1 bg-body rounded-5 position-relative">
            ...
            <?php if (isset($deleteStatus['error_kalimat'])) echo $deleteStatus['error_kalimat'] ?>
            <form action="" method="POST">
                <h3 class="mb-3 font-weight-bold"">Ketikan " <?php echo $validation_text; ?>"</h3>
                    ...
                    <div class="row d-grid gap-2 col-6 mx-auto">
                        ...
                        <h6 class="text-center"><a href="home.php" class="text-decoration-none"><small>Kembali</small></a>
                </h3>
            </form>
        </div>
    </main>
