                        ...
                        <div class='card'>
                            <div class="media-body p-5 mr-5">
                                ...
                                <div class="media-body">
                                    <h4><a target="_blank" class="text-decoration-none text-reset" href="./user.php?username=<?= $post["username"]; ?>"><?= " " . $post["username"]; ?></a><small> - <small><?= $post['waktu_aksi']; ?></small></small></h4>
                                    <p><?= $post['deskripsi']; ?></p>
                                </div>
