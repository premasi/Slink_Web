                    ...
                    <div class='card'>
                        <div class="media-body p-5 mr-5">
                            ...
                            <div class="media-body">
                                ...
                                <h4><a target="_blank" class="text-decoration-none text-reset"
                                        href="./user.php?username=<?= $post["username"]; ?>"><?= " " . $post["username"]; ?></a><small>
                            ...
                            <a class="btn shadow mb-3" href="<?= $post["link"] ?>"
                                style="background-color:#6aa5a9; color: white;" target="_blank">Go Link</a><br>
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <form action="" method="POST" id="comment_form">
                                ...
                                <textarea class="form-control form-control-sm mb-2" id="comment" name="comment"
