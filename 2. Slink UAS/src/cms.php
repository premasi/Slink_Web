        ...
        <main class="container shadow p-3 mb-5 bg-body rounded m-auto mt-5">
            <div class="row mb-2 d-flex">
                ...
                <div class="col-3">
                    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                        data-bs-target="#modal_form" id="trigger_createPost">+ Tambah Post</button>
                </div>
            ...
            <form action="" method="POST">
                <div class="input-group mb-3 mt-4 col-4 row">
                    ...
                    <div class="col-3">
                        <button type="submit" class="btn btn-outline-success col-4" type="button"
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <a class="btn btn-primary col-5" href="<?= $post['link']; ?>" target="_blank">Go
                                    Link</a>
                                <div class="col-1"></div>
                                <div class="d-grid gap-2 d-md-flex col-4">
                                    <button class="btn btn-outline-danger " type="button"
                                        onclick="return confirm('Yakin Menghapus Post?')"><a
                                            href="cms.php?delete_id=<?= $post["id"]; ?>"
                                            class="text-reset text-decoration-none">Hapus</a></button>
                                    <button class="btn btn-outline-success  trigger_updatePost" type=" button"
                    ...
                    <div class="modal-content">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" list="list_category" id="category" name="category"
                                    placeholder="Pilih Category..." class="form-control mb-2" />
