              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="d-grid gap-2 d-md-flex col-4">
                    <button class="btn btn-outline-danger " type="button" onclick="return confirm('Yakin Menghapus Post?')"><a href="cms.php?delete_id=<?= $post["id"]; ?>" class="text-reset text-decoration-none">Hapus</a></button>
