...
<head>
    ...
    <title>Slink | Your Bookmarks</title>
</head>
    ...
    <main class="row">
        <section class="container m-auto mt-3 p-3 w-50">
            ...
            <div class="row" id="new_posts">
                ...
                <center>
                    <h3>Anda Tidak Memiliki Bookmark!</h3>
                </center>
                <?php endif; ?>
                        ...
                        <h2><a style="font-size: 25px; text-decoration: none;color:black"
                            ...
                            <h2>
                                <div class="d-flex justify-content-between">
                                    <h5 class=""><span style="color: #45625D;">by</span><a target="_blank"
                                            class="text-decoration-none text-reset"
                                            href="./user.php?username=<?= $post["username"]; ?>"><?= " " . $post["username"]; ?></a>
                                    </h5>
                                    <h5 class="mx-4" style="font-size: 15px;"><?= $post['waktu_aksi']; ?></h5>
                                </div>
                                ...
                                <i class="<?= $likeCondition; ?>" style="cursor:pointer ;"
                                    data-id="<?= $post["id"] ?>"></i>
                                <i class="bi bi-chat fs-5 mx-1 comment_button" style="cursor:pointer ;"
                                    data-bs-toggle="modal" data-bs-target="#modal_form"
                                    data-id="<?= $post['id'] ?>"></i>
                                <i class="<?= $bookmarkCondition; ?>" style="cursor:pointer ;"
                                    data-id="<?= $post["id"] ?>" data-reload="1"></i>
