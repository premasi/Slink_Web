                            ...
                            <h2><a style="font-size: 25px; text-decoration: none;color:black" href="post.php?post_id=<?= $post['id']; ?>" target="_blank"><?= $post['judul']; ?></a>
                                <h2>
                                    <div class="d-flex justify-content-between">
                                        <h5 class=""><span style="color: #45625D;">by</span><a target="_blank" class="text-decoration-none text-reset" href="./user.php?username=<?= $post["username"]; ?>"><?= " " . $post["username"]; ?></a>
                                        </h5>
                                    ...
                                    <i class="<?= $bookmarkCondition; ?>" style="cursor:pointer ;" data-id="<?= $post["id"] ?>" data-reload="1"></i>
