...
var Data_Log = JSON.parse(localStorage.getItem("log-user"));
var Data = JSON.parse(localStorage.getItem(`data-posts-${Data_Log.id}`));
...
const insertPost = (e) => {
  ...
  if (Data === null) {
    Data = [];
    Data.push(newPost);
    localStorage.setItem(`data-posts-${Data_Log.id}`, JSON.stringify(Data));
